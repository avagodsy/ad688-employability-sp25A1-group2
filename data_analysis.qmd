...
plt.show()
plt.write_image("figures/missing_values.png")
plt.write_html("figures/missing_values.html")
```
...
plt.tight_layout()
plt.show()
plt.write_image("figures/top_postings.png")
plt.write_html("figures/top_postings.html")
```
...
plt.write_image("figures/salary_dist.png")
plt.write_html("figures/salary_dist.html")
...
plt.show()
plt.write_image("figures/remote_onsite.png")
plt.write_html("figures/remote_onsite.html")
